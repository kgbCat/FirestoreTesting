//
//  VKLoginControlle.swift
//  vkApp
//
//  Created by Anna Delova on 5/25/21.
//

import UIKit
import WebKit

class VKLoginControlle: UIViewController {
...
extension VKLoginControlle: WKNavigationDelegate {
    func webView(_ webView: WKWebView, decidePolicyFor navigationResponse: WKNavigationResponse, decisionHandler: @escaping (WKNavigationResponsePolicy) -> Void) {
        ...
        performSegue(withIdentifier: Constants.loginVK, sender: nil)
